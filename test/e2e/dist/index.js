...
], App.prototype, "changeStatus", null);
App = __decorate([
...
exports.Once = exports.Subscribe = exports.Action = undefined;
...
Object.defineProperty(exports, 'Subscribe', {
  enumerable: true,
  get: function get() {
    return _decorators.Subscribe;
  }
});
Object.defineProperty(exports, 'Once', {
  enumerable: true,
  get: function get() {
    return _decorators.Once;
  }
});

var _constructor = __webpack_require__(9);
...
exports.Action = exports.Once = exports.Subscribe = undefined;
...
var VueSub = function () {
    ...
    _createClass(VueSub, [{
        ...
        key: 'unsubscribe',
        value: function unsubscribe(action, handler) {
            var observers = this.observers;
            var actionHandlers = observers[action];
            if (actionHandlers === undefined) return false;
            var index = actionHandlers.indexOf(handler);
        ...
        value: function once(action, handler) {
            ...
            var selfDestroying = function selfDestroying(params) {
                handler(params);
                return _this.unsubscribe(action, selfDestroying);
            };
            return this.subscribe(action, selfDestroying);
        }
    }, {
        key: 'fire',
        value: function fire(action, params) {
            var actionHandlers = this.observers[action];
            if (!actionHandlers) return false;
            (0, _utils.forEach)(actionHandlers, function (handler) {
        ...
        key: 'setObservers',
        value: function setObservers(observers) {
            if ((0, _utils.isValidObservers)(observers)) {
...
var forEach = function forEach(array, handler) {
    for (var i = 0; i < array.length; i++) {
        handler(array[i], i);
    }
};
var every = function every(array, checker) {
    for (var i = 0; i < array.length; i++) {
